...
require "ecm/assets/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
  s.name        = "ecm_assets"
  s.version     = Ecm::Assets::VERSION
  s.authors     = ["Roberto Vasquez Angel"]
  s.email       = ["roberto@vasquez-angel.de"]
  s.homepage    = "https://github.com/robotex82/ecm_assets"
  s.summary     = "ECM Assets module"
  s.description = "Provides asset management for active admin"
